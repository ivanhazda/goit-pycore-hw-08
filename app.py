...
class Record:
    ...
    def edit_phone(self, phone_number_old, phone_number_new):
        ...
        # РЎС‚РІРѕСЂСЋС”РјРѕ РЅРѕРІРёР№ РѕР±'С”РєС‚ Phone РґР»СЏ РІР°Р»С–РґР°С†С–С— РЅРѕРІРѕРіРѕ РЅРѕРјРµСЂР°
...
class AddressBook(UserDict):
        ...
        for record in self.data.values():
            if record.birthday:
                ...
                if 0 <= days_until_birthday <= 7:
                    ...
                    elif birthday_this_year.weekday() == 6:  # РЅРµРґС–Р»СЏ
    ...
    def __str__(self):
        if not self.data:
            return "РђРґСЂРµСЃРЅР° РєРЅРёРіР° РїРѕСЂРѕР¶РЅСЏ."
...
def load_data(filename="addressbook.pkl"):
    try:
        ...
        return AddressBook()  # РџРѕРІРµСЂС‚Р°С”РјРѕ РЅРѕРІСѓ РєРЅРёРіСѓ, СЏРєС‰Рѕ С„Р°Р№Р» РЅРµ С–СЃРЅСѓС”
...
def main():
    ...
    while True:
        ...
        # add-birthday - РґРѕРґР°С”РјРѕ РґРѕ РєРѕРЅС‚Р°РєС‚Сѓ РґРµРЅСЊ РЅР°СЂРѕРґР¶РµРЅРЅСЏ РІ С„РѕСЂРјР°С‚С– DD.MM.YYYY
        elif command == "add-birthday":
            print(add_birthday(args, book))
        # show-birthday - РїРѕРєР°Р·СѓС”РјРѕ РґРµРЅСЊ РЅР°СЂРѕРґР¶РµРЅРЅСЏ РєРѕРЅС‚Р°РєС‚Сѓ
